...
class Main:
    ...
    def log(self):
        ...
        self.head['text'] = 'RECIPE RESERVOIR - LOGIN'
        self.logf.pack()
    ...
    # Draw Widgets
    def widgets(self):
        self.head = Label(self.master, text='RECIPE RESERVOIR - Login', font=('Times', 35), pady=10)
        self.head.pack()
...
if __name__ == '__main__':
    ...
    # and setup window
    root = Tk()
    root.title('Recipe Reservoir - Login Form')
